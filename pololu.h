...
#define CONVOY_MOTOR_FWD			2000
#define CONVOY_MOTOR_BWD			600
...
#define CRUSHER_MOTOR_CW_MAX_SPEED	2000
#define CRUSHER_MOTOR_ACW_MAX_SPEED 1000
#define CRUSHER_MOTOR_IDLE			1500

//#define
#define POLOLU_CRUSHER_MOTOR					0
#define POLOLU_EXTRUDER_MOTOR					1
#define POLOLU_EXTRUDER_HEATER					8
